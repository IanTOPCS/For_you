/**
  ...
  *              - To use or not the peripheral̼ drivers in application code(i.e. 
  *                code will be based on direct access to peripheral̼ registers 
  ...
  *           - Macros to access peripheral̼ registers hardware
  *  
  ******************************************************************************
  * @attention
  *
